...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 24 2016 г., 16:33
...
--
-- Структура таблицы `j3_assets`
--

DROP TABLE IF EXISTS `j3_assets`;
CREATE TABLE IF NOT EXISTS `j3_assets` (
...
(57, 18, 68, 69, 2, 'com_modules.module.88', 'Модуль формы Fabrik', '{}'),
(62, 1, 109, 110, 1, 'com_jce', 'jce', '{}'),
(63, 1, 111, 112, 1, 'com_fieldsattach', 'fieldsattach', '{}'),
(64, 1, 113, 114, 1, 'com_widgetkit', 'com_widgetkit', '{}'),
(65, 18, 70, 71, 2, 'com_modules.module.87', 'Widgetkit', '{}'),
(66, 18, 72, 73, 2, 'com_modules.module.89', 'Модуль списка Fabrik', '{}'),
(67, 1, 115, 116, 1, 'com_fabrik', 'com_fabrik', '{}');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_associations`
--

DROP TABLE IF EXISTS `j3_associations`;
CREATE TABLE IF NOT EXISTS `j3_associations` (
...
--
-- Структура таблицы `j3_banners`
--

DROP TABLE IF EXISTS `j3_banners`;
CREATE TABLE IF NOT EXISTS `j3_banners` (
...
--
-- Структура таблицы `j3_banner_clients`
--

DROP TABLE IF EXISTS `j3_banner_clients`;
CREATE TABLE IF NOT EXISTS `j3_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `j3_banner_tracks`
--

DROP TABLE IF EXISTS `j3_banner_tracks`;
CREATE TABLE IF NOT EXISTS `j3_banner_tracks` (
...
--
-- Структура таблицы `j3_categories`
--

DROP TABLE IF EXISTS `j3_categories`;
CREATE TABLE IF NOT EXISTS `j3_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `j3_categories`
--

INSERT INTO `j3_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Без категории', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 148, '2014-09-10 17:35:05', 0, '*', 1),
...
--
-- Структура таблицы `j3_contact_details`
--

DROP TABLE IF EXISTS `j3_contact_details`;
CREATE TABLE IF NOT EXISTS `j3_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `j3_content`
--

DROP TABLE IF EXISTS `j3_content`;
CREATE TABLE IF NOT EXISTS `j3_content` (
...
--
-- Структура таблицы `j3_contentitem_tag_map`
--

DROP TABLE IF EXISTS `j3_contentitem_tag_map`;
CREATE TABLE IF NOT EXISTS `j3_contentitem_tag_map` (
...
--
-- Структура таблицы `j3_content_frontpage`
--

DROP TABLE IF EXISTS `j3_content_frontpage`;
CREATE TABLE IF NOT EXISTS `j3_content_frontpage` (
...
--
-- Структура таблицы `j3_content_rating`
--

DROP TABLE IF EXISTS `j3_content_rating`;
CREATE TABLE IF NOT EXISTS `j3_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `j3_content_types`
--

DROP TABLE IF EXISTS `j3_content_types`;
CREATE TABLE IF NOT EXISTS `j3_content_types` (
...
--
-- Дамп данных таблицы `j3_content_types`
--

INSERT INTO `j3_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `j3_core_log_searches`
--

DROP TABLE IF EXISTS `j3_core_log_searches`;
CREATE TABLE IF NOT EXISTS `j3_core_log_searches` (
...
--
-- Структура таблицы `j3_extensions`
--

DROP TABLE IF EXISTS `j3_extensions`;
CREATE TABLE IF NOT EXISTS `j3_extensions` (
...
INSERT INTO `j3_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"d953e62b56fbe35518ee9549889536f1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(412, 'plg_editors_tinymce', 'plugin', 'tinymce', 'editors', 0, 1, 1, 0, '{"name":"plg_editors_tinymce","type":"plugin","creationDate":"2005-2016","author":"Ephox Corporation","copyright":"Ephox Corporation","authorEmail":"N\\/A","authorUrl":"http:\\/\\/www.tinymce.com","version":"4.3.12","description":"PLG_TINY_XML_DESCRIPTION","group":"","filename":"tinymce"}', '{"mode":"1","skin":"0","mobile":"0","entity_encoding":"raw","lang_mode":"1","text_direction":"ltr","content_css":"1","content_css_custom":"","relative_urls":"1","newlines":"0","invalid_elements":"script,applet,iframe","extended_elements":",@[data-lightbox],@[data-spotlight],@[data-lightbox],@[data-spotlight]","html_height":"550","html_width":"750","resizing":"1","element_path":"1","fonts":"1","paste":"1","searchreplace":"1","insertdate":"1","colors":"1","table":"1","smilies":"1","hr":"1","link":"1","media":"1","print":"1","directionality":"1","fullscreen":"1","alignment":"1","visualchars":"1","visualblocks":"1","nonbreaking":"1","template":"1","blockquote":"1","wordcount":"1","advlist":"1","autosave":"1","contextmenu":"1","inlinepopups":"1","custom_plugin":"","custom_button":""}', '', '', 0, '0000-00-00 00:00:00', 3, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1472040333}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1472040489,"unique_id":"a575f570d5da980ae6b6d6614e1fd892068959cd","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10031, 'fieldsattach', 'component', 'com_fieldsattach', '', 1, 1, 0, 0, '{"name":"fieldsattach","type":"component","creationDate":"Genuary 2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright Info","authorEmail":"cristian@percha.com","authorUrl":"http:\\/\\/www.percha.com","version":"3.5.0.8","description":"","group":"","filename":"fieldsattach"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10032, 'Fieldsattach - fieldsattachements Input', 'plugin', 'input', 'fieldsattachment', 0, 1, 1, 0, '{"name":"Fieldsattach - fieldsattachements Input","type":"plugin","creationDate":"04-12-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"1.6","description":"Input Field","group":"","filename":"input"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10033, 'Fieldsattach - fieldsattachements file', 'plugin', 'file', 'fieldsattachment', 0, 1, 1, 0, '{"name":"Fieldsattach - fieldsattachements file","type":"plugin","creationDate":"04-12-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"2.5","description":"File Field","group":"","filename":"file"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10034, 'Fieldsattach - fieldsattachements image', 'plugin', 'image', 'fieldsattachment', 0, 1, 1, 0, '{"name":"Fieldsattach - fieldsattachements image","type":"plugin","creationDate":"04-12-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"1.9","description":"Image Field","group":"","filename":"image"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10035, 'Fieldsattach - fieldsattachements imagegallery', 'plugin', 'imagegallery', 'fieldsattachment', 0, 1, 1, 0, '{"name":"Fieldsattach - fieldsattachements imagegallery","type":"plugin","creationDate":"04-12-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"1.9","description":"imagegallery Field","group":"","filename":"imagegallery"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10036, 'Fieldsattach - fieldsattachements select', 'plugin', 'select', 'fieldsattachment', 0, 1, 1, 0, '{"name":"Fieldsattach - fieldsattachements select","type":"plugin","creationDate":"04-12-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"1.5","description":"Select Field","group":"","filename":"select"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10037, 'Fieldsattach - fieldsattachements textarea', 'plugin', 'textarea', 'fieldsattachment', 0, 1, 1, 0, '{"name":"Fieldsattach - fieldsattachements textarea","type":"plugin","creationDate":"04-12-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"1.2","description":"Textarea Field","group":"","filename":"textarea"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10038, 'Content - Fieldsattach content', 'plugin', 'fieldsattachment', 'content', 0, 1, 1, 0, '{"name":"Content - Fieldsattach content","type":"plugin","creationDate":"December 2, 2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"(C) 2010 Cristian Gra\\u00f1\\u00f3 Reder. All rights reserved.","authorEmail":"cristian@percha.com","authorUrl":"http:\\/\\/www.percha.com","version":"1.7","description":"PERCHA field ATTACHMENT PLUGIN INSTALLED","group":"","filename":"fieldsattachment"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10039, 'System - fieldsattachements', 'plugin', 'fieldsattachment', 'system', 0, 1, 1, 0, '{"name":"System - fieldsattachements","type":"plugin","creationDate":"20-01-2011","author":"Cristian Gra\\u00f1\\u00f3 Reder","copyright":"Copyright (C) 2005 - 2011 Open Source Cristian Gra\\u00f1\\u00f3. All rights reserved.","authorEmail":"cristiangrano@hotmail.com\\t","authorUrl":"www.percha.com","version":"4.5.6","description":"Provides insert fields in article","group":"","filename":"fieldsattachment"}', '{"oneclicksave":"1","logs":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10052, 'mod_fabrik_form', 'module', 'mod_fabrik_form', '', 0, 1, 0, 0, '{"name":"mod_fabrik_form","type":"module","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"MOD_FABRIK_FORM_XML_DESCRIPTION","group":"","filename":"mod_fabrik_form"}', '{"formid":"0","row_id":"0","usekey":"","template":"default","formmodule_useajax":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10053, 'mod_fabrik_list', 'module', 'mod_fabrik_list', '', 0, 1, 0, 0, '{"name":"mod_fabrik_list","type":"module","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"MOD_FABRIK_LIST_XML_DESCRIPTION","group":"","filename":"mod_fabrik_list"}', '{"useajax":"0","ajax_links":"","radomizerecords":"0","limit":"0","show_nav":"","fabriklayout":"","show-title":"","show_into":"1","show_outro":"1","show_filters":"1","resetfilters":"0","clearfilters":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10054, 'plg_fabrik_system', 'plugin', 'fabrik', 'system', 0, 1, 1, 0, '{"name":"plg_fabrik_system","type":"plugin","creationDate":"July 2016","author":"Fabrikar.com","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.pollen-8.co.uk","version":"3.5","description":"PLG_FABRIK_SYSTEM_DESCRIPTION","group":"","filename":"fabrik"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10055, 'System - Fabrik Scheduled Tasks', 'plugin', 'fabrikcron', 'system', 0, 0, 1, 0, '{"name":"System - Fabrik Scheduled Tasks","type":"plugin","creationDate":"July 2016","author":"Pollen 8","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.pollen-8.co.uk","version":"3.5","description":"Runs Fabrik scheduled tasks","group":"","filename":"fabrikcron"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10056, 'plg_fabrik', 'plugin', 'fabrik', 'content', 0, 1, 1, 0, '{"name":"plg_fabrik","type":"plugin","creationDate":"July 2016","author":"Pollen 8 Design Ltd","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FABRIK_DESCRIPTION","group":"","filename":"fabrik"}', '{"botRegex":"fabrik"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10057, 'plg_fabrik_cron_email', 'plugin', 'email', 'fabrik_cron', 0, 1, 1, 0, '{"name":"plg_fabrik_cron_email","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FABRIK_CRON_EMAIL_DESCRIPTION","group":"","filename":"email"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10058, 'plg_fabrik_cron_php', 'plugin', 'php', 'fabrik_cron', 0, 1, 1, 0, '{"name":"plg_fabrik_cron_php","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FABRIK_CRON_PHP_DESCRIPTION","group":"","filename":"php"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10059, 'plg_fabrik_element_button', 'plugin', 'button', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_button","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_BUTTON_DESCRIPTION","group":"","filename":"button"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10060, 'plg_fabrik_element_checkbox', 'plugin', 'checkbox', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_checkbox","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_CHECKBOX_DESCRIPTION","group":"","filename":"checkbox"}', '{"defaultFieldType":"TEXT"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10061, 'plg_fabrik_element_databasejoin', 'plugin', 'databasejoin', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_databasejoin","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_DATABASEJOIN_DESCRIPTION","group":"","filename":"databasejoin"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10062, 'plg_fabrik_element_date', 'plugin', 'date', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_date","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_DATE_DESCRIPTION","group":"","filename":"date"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10063, 'plg_fabrik_element_display', 'plugin', 'display', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_display","type":"plugin","creationDate":"July 2016","author":"Hugh Messenger","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_DISPLAY_DESCRIPTION","group":"","filename":"display"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10064, 'plg_fabrik_element_dropdown', 'plugin', 'dropdown', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_dropdown","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_DROPDOWN_DESCRIPTION","group":"","filename":"dropdown"}', '{"defaultFieldType":"TEXT"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10065, 'plg_fabrik_element_field', 'plugin', 'field', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_field","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_FIELD_DESCRIPTION","group":"","filename":"field"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10066, 'plg_fabrik_element_fileupload', 'plugin', 'fileupload', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_fileupload","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_FILEUPLOAD_DESCRIPTION","group":"","filename":"fileupload"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10067, 'plg_fabrik_element_googlemap', 'plugin', 'googlemap', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_googlemap","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_GOOGLEMAP_DESCRIPTION","group":"","filename":"googlemap"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10068, 'plg_fabrik_element_image', 'plugin', 'image', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_image","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_IMAGE_DESCRIPTION","group":"","filename":"image"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10069, 'plg_fabrik_element_internalid', 'plugin', 'internalid', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_internalid","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_INTERNALID_DESCRIPTION","group":"","filename":"internalid"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10070, 'plg_fabrik_element_link', 'plugin', 'link', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_link","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_LINK_DESCRIPTION","group":"","filename":"link"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);
INSERT INTO `j3_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(10071, 'plg_fabrik_element_radiobutton', 'plugin', 'radiobutton', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_radiobutton","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_RADIOBUTTON_DESCRIPTION","group":"","filename":"radiobutton"}', '{"defaultFieldType":"TEXT"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10072, 'plg_fabrik_element_textarea', 'plugin', 'textarea', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_textarea","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_TEXTAREA_DESCRIPTION","group":"","filename":"textarea"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10073, 'plg_fabrik_element_user', 'plugin', 'user', 'fabrik_element', 0, 1, 1, 0, '{"name":"plg_fabrik_element_user","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_ELEMENT_USER_DESCRIPTION","group":"","filename":"user"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10074, 'plg_fabrik_form_email', 'plugin', 'email', 'fabrik_form', 0, 1, 1, 0, '{"name":"plg_fabrik_form_email","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FORM_EMAIL_DESCRIPTION","group":"","filename":"email"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10075, 'plg_fabrik_form_php', 'plugin', 'php', 'fabrik_form', 0, 1, 1, 0, '{"name":"plg_fabrik_form_php","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FORM_PHP_DESCRIPTION","group":"","filename":"php"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10076, 'plg_fabrik_form_receipt', 'plugin', 'receipt', 'fabrik_form', 0, 1, 1, 0, '{"name":"plg_fabrik_form_receipt","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FORM_RECEIPT_DESCRIPTION","group":"","filename":"receipt"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10077, 'plg_fabrik_form_redirect', 'plugin', 'redirect', 'fabrik_form', 0, 1, 1, 0, '{"name":"plg_fabrik_form_redirect","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_FORM_REDIRECT_DESCRIPTION","group":"","filename":"redirect"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10078, 'plg_fabrik_list_copy', 'plugin', 'copy', 'fabrik_list', 0, 1, 1, 0, '{"name":"plg_fabrik_list_copy","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_LIST_COPY_DESCRIPTION","group":"","filename":"copy"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10079, 'plg_fabrik_list_php', 'plugin', 'php', 'fabrik_list', 0, 1, 1, 0, '{"name":"plg_fabrik_list_php","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_LIST_PHP_DESCRIPTION","group":"","filename":"php"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10080, 'plg_fabrik_validationrule_isgreaterorlessthan', 'plugin', 'isgreaterorlessthan', 'fabrik_validationrule', 0, 1, 1, 0, '{"name":"plg_fabrik_validationrule_isgreaterorlessthan","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VALIDATIONRULE_ISGREATERORLESSTHAN_DESCRIPTION","group":"","filename":"isgreaterorlessthan"}', '{"icon":"star"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10081, 'plg_fabrik_validationrule_notempty', 'plugin', 'notempty', 'fabrik_validationrule', 0, 1, 1, 0, '{"name":"plg_fabrik_validationrule_notempty","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VALIDATIONRULE_NOTEMPTY_DESCRIPTION","group":"","filename":"notempty"}', '{"icon":"eye-open"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10082, 'plg_fabrik_validationrule_php', 'plugin', 'php', 'fabrik_validationrule', 0, 1, 1, 0, '{"name":"plg_fabrik_validationrule_php","type":"plugin","creationDate":"July 2016","author":"Hugh Messenger","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"hugh.messenger@gmail.com","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VALIDATIONRULE_PHP_DESCRIPTION","group":"","filename":"php"}', '{"icon":"star"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10083, 'plg_fabrik_validationrule_regex', 'plugin', 'regex', 'fabrik_validationrule', 0, 1, 1, 0, '{"name":"plg_fabrik_validationrule_regex","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VALIDATIONRULE_REGEX_DESCRIPTION","group":"","filename":"regex"}', '{"icon":"star"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10084, 'plg_fabrik_validationrule_isemail', 'plugin', 'isemail', 'fabrik_validationrule', 0, 1, 1, 0, '{"name":"plg_fabrik_validationrule_isemail","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VALIDATIONRULE_ISEMAIL_DESCRIPTION","group":"","filename":"isemail"}', '{"icon":"envelope"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10085, 'plg_fabrik_visualization_calendar', 'plugin', 'calendar', 'fabrik_visualization', 0, 1, 1, 0, '{"name":"plg_fabrik_visualization_calendar","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VISUALIZATION_CALENDAR_DESCRIPTION","group":"","filename":"calendar"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10086, 'plg_fabrik_visualization_chart', 'plugin', 'chart', 'fabrik_visualization', 0, 1, 1, 0, '{"name":"plg_fabrik_visualization_chart","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VISUALIZATION_CHART_DESCRIPTION","group":"","filename":"chart"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10087, 'plg_fabrik_visualization_googlemap', 'plugin', 'googlemap', 'fabrik_visualization', 0, 1, 1, 0, '{"name":"plg_fabrik_visualization_googlemap","type":"plugin","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VISUALIZATION_GOOGLEMAP_DESCRIPTION","group":"","filename":"googlemap"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10088, 'PLG_FABRIK_VISUALIZATION_FULLCALENDAR', 'plugin', 'fullcalendar', 'fabrik_visualization', 0, 1, 1, 0, '{"name":"PLG_FABRIK_VISUALIZATION_FULLCALENDAR","type":"plugin","creationDate":"July 2016","author":"Hugh Messenger","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"hugh.messenger@gmail.com","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VISUALIZATION_FULLCALENDAR_DESCRIPTION","group":"","filename":"fullcalendar"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10089, 'plg_fabrik_visualization_media', 'plugin', 'media', 'fabrik_visualization', 0, 1, 1, 0, '{"name":"plg_fabrik_visualization_media","type":"plugin","creationDate":"July 2016","author":"Hugh Messenger","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"hugh.messenger@gmail.com","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VISUALIZATION_MEDIA_DESCRIPTION","group":"","filename":"media"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10090, 'plg_fabrik_visualization_slideshow', 'plugin', 'slideshow', 'fabrik_visualization', 0, 1, 1, 0, '{"name":"plg_fabrik_visualization_slideshow","type":"plugin","creationDate":"July 2016","author":"Hugh Messenger","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"hugh.messenger@gmail.com","authorUrl":"www.fabrikar.com","version":"3.5","description":"PLG_VISUALIZATION_SLIDESHOW_DESCRIPTION","group":"","filename":"slideshow"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10091, 'com_fabrik', 'component', 'com_fabrik', '', 1, 1, 0, 0, '{"name":"com_fabrik","type":"component","creationDate":"July 2016","author":"Rob Clayburn","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"rob@pollen-8.co.uk","authorUrl":"www.pollen-8.co.uk","version":"3.5","description":"COM_FABRIK_XML_DESCRIPTION","group":"","filename":"fabrik"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10092, 'Fabrik Package', 'package', 'pkg_fabrik', '', 0, 1, 1, 0, '{"name":"Fabrik Package","type":"package","creationDate":"July 2016","author":"Fabrik","copyright":"Copyright (C) 2005-2016 fabrikar.com - All rights reserved.","authorEmail":"","authorUrl":"","version":"3.5","description":"Fabrik Package","group":"","filename":"pkg_fabrik"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_fabrik_connections`
--

DROP TABLE IF EXISTS `j3_fabrik_connections`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_connections` (
...
--
-- Дамп данных таблицы `j3_fabrik_connections`
--

INSERT INTO `j3_fabrik_connections` (`id`, `host`, `user`, `password`, `database`, `description`, `published`, `checked_out`, `checked_out_time`, `default`, `params`) VALUES
(1, 'localhost', 'root', '', 'demo12', 'site database', 1, 0, NULL, 1, '');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_fabrik_cron`
--

DROP TABLE IF EXISTS `j3_fabrik_cron`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_cron` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_elements`
--

DROP TABLE IF EXISTS `j3_fabrik_elements`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_elements` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_formgroup`
--

DROP TABLE IF EXISTS `j3_fabrik_formgroup`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_formgroup` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_forms`
--

DROP TABLE IF EXISTS `j3_fabrik_forms`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_forms` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_form_sessions`
--

DROP TABLE IF EXISTS `j3_fabrik_form_sessions`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_form_sessions` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_groups`
--

DROP TABLE IF EXISTS `j3_fabrik_groups`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_groups` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `css` text NOT NULL,
  `label` varchar(100) NOT NULL,
...
--
-- Структура таблицы `j3_fabrik_joins`
--

DROP TABLE IF EXISTS `j3_fabrik_joins`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_joins` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_jsactions`
--

DROP TABLE IF EXISTS `j3_fabrik_jsactions`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_jsactions` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_lists`
--

DROP TABLE IF EXISTS `j3_fabrik_lists`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_lists` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `label` varchar(255) NOT NULL,
...
--
-- Структура таблицы `j3_fabrik_log`
--

DROP TABLE IF EXISTS `j3_fabrik_log`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_log` (
...
--
-- Структура таблицы `j3_fabrik_packages`
--

DROP TABLE IF EXISTS `j3_fabrik_packages`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_packages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_validations`
--

DROP TABLE IF EXISTS `j3_fabrik_validations`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_validations` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fabrik_visualizations`
--

DROP TABLE IF EXISTS `j3_fabrik_visualizations`;
CREATE TABLE IF NOT EXISTS `j3_fabrik_visualizations` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `plugin` varchar(100) NOT NULL,
  `label` varchar(255) NOT NULL,
...
--
-- Структура таблицы `j3_fieldsattach`
--

DROP TABLE IF EXISTS `j3_fieldsattach`;
CREATE TABLE IF NOT EXISTS `j3_fieldsattach` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fieldsattach_categories_values`
--

DROP TABLE IF EXISTS `j3_fieldsattach_categories_values`;
CREATE TABLE IF NOT EXISTS `j3_fieldsattach_categories_values` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fieldsattach_groups`
--

DROP TABLE IF EXISTS `j3_fieldsattach_groups`;
CREATE TABLE IF NOT EXISTS `j3_fieldsattach_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fieldsattach_images`
--

DROP TABLE IF EXISTS `j3_fieldsattach_images`;
CREATE TABLE IF NOT EXISTS `j3_fieldsattach_images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_fieldsattach_values`
--

DROP TABLE IF EXISTS `j3_fieldsattach_values`;
CREATE TABLE IF NOT EXISTS `j3_fieldsattach_values` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `articleid` int(11) NOT NULL,
  `fieldsid` int(11) NOT NULL,
  `value` text NOT NULL,
...
--
-- Структура таблицы `j3_finder_filters`
--

DROP TABLE IF EXISTS `j3_finder_filters`;
CREATE TABLE IF NOT EXISTS `j3_finder_filters` (
...
--
-- Структура таблицы `j3_finder_links`
--

DROP TABLE IF EXISTS `j3_finder_links`;
CREATE TABLE IF NOT EXISTS `j3_finder_links` (
...
--
-- Структура таблицы `j3_finder_links_terms0`
--

DROP TABLE IF EXISTS `j3_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms0` (
...
--
-- Структура таблицы `j3_finder_links_terms1`
--

DROP TABLE IF EXISTS `j3_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms2`
--

DROP TABLE IF EXISTS `j3_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms3`
--

DROP TABLE IF EXISTS `j3_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms4`
--

DROP TABLE IF EXISTS `j3_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms5`
--

DROP TABLE IF EXISTS `j3_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms6`
--

DROP TABLE IF EXISTS `j3_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms7`
--

DROP TABLE IF EXISTS `j3_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms8`
--

DROP TABLE IF EXISTS `j3_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_terms9`
--

DROP TABLE IF EXISTS `j3_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_termsa`
--

DROP TABLE IF EXISTS `j3_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_termsb`
--

DROP TABLE IF EXISTS `j3_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_termsc`
--

DROP TABLE IF EXISTS `j3_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_termsd`
--

DROP TABLE IF EXISTS `j3_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_termse`
--

DROP TABLE IF EXISTS `j3_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_links_termsf`
--

DROP TABLE IF EXISTS `j3_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `j3_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `j3_finder_taxonomy`
--

DROP TABLE IF EXISTS `j3_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `j3_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `j3_finder_taxonomy`
--

INSERT INTO `j3_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `j3_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `j3_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `j3_finder_terms`
--

DROP TABLE IF EXISTS `j3_finder_terms`;
CREATE TABLE IF NOT EXISTS `j3_finder_terms` (
...
--
-- Структура таблицы `j3_finder_terms_common`
--

DROP TABLE IF EXISTS `j3_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `j3_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `j3_finder_terms_common`
--

INSERT INTO `j3_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `j3_finder_tokens`
--

DROP TABLE IF EXISTS `j3_finder_tokens`;
CREATE TABLE IF NOT EXISTS `j3_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `j3_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `j3_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `j3_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `j3_finder_types`
--

DROP TABLE IF EXISTS `j3_finder_types`;
CREATE TABLE IF NOT EXISTS `j3_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_languages`
--

DROP TABLE IF EXISTS `j3_languages`;
CREATE TABLE IF NOT EXISTS `j3_languages` (
...
--
-- Дамп данных таблицы `j3_languages`
--

INSERT INTO `j3_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_menu`
--

DROP TABLE IF EXISTS `j3_menu`;
CREATE TABLE IF NOT EXISTS `j3_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(122, 'main', 'com_fabrik', 'com-fabrik', '', 'com-fabrik', 'index.php?option=com_fabrik', 'component', 0, 1, 1, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/fabrik.png', 0, '{}', 63, 78, 0, '', 1),
(123, 'main', 'com_fabrik_lists', 'com-fabrik-lists', '', 'com-fabrik/com-fabrik-lists', 'index.php?option=com_fabrik&view=lists', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/lists.png', 0, '{}', 64, 65, 0, '', 1),
(124, 'main', 'com_fabrik_forms', 'com-fabrik-forms', '', 'com-fabrik/com-fabrik-forms', 'index.php?option=com_fabrik&view=forms', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/forms.png', 0, '{}', 66, 67, 0, '', 1),
(125, 'main', 'com_fabrik_groups', 'com-fabrik-groups', '', 'com-fabrik/com-fabrik-groups', 'index.php?option=com_fabrik&view=groups', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/groups.png', 0, '{}', 68, 69, 0, '', 1),
(126, 'main', 'com_fabrik_elements', 'com-fabrik-elements', '', 'com-fabrik/com-fabrik-elements', 'index.php?option=com_fabrik&view=elements', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/elements.png', 0, '{}', 70, 71, 0, '', 1),
(127, 'main', 'com_fabrik_visualizations', 'com-fabrik-visualizations', '', 'com-fabrik/com-fabrik-visualizations', 'index.php?option=com_fabrik&view=visualizations', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/visualizations.png', 0, '{}', 72, 73, 0, '', 1),
(128, 'main', 'com_fabrik_connections', 'com-fabrik-connections', '', 'com-fabrik/com-fabrik-connections', 'index.php?option=com_fabrik&view=connections', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/connections.png', 0, '{}', 74, 75, 0, '', 1),
(129, 'main', 'com_fabrik_schedule', 'com-fabrik-schedule', '', 'com-fabrik/com-fabrik-schedule', 'index.php?option=com_fabrik&view=crons', 'component', 0, 122, 2, 10091, 0, '0000-00-00 00:00:00', 0, 1, '../administrator/components/com_fabrik/images/schedules.png', 0, '{}', 76, 77, 0, '', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_menu_types`
--

DROP TABLE IF EXISTS `j3_menu_types`;
CREATE TABLE IF NOT EXISTS `j3_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `j3_menu_types`
--

INSERT INTO `j3_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Главное меню', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_messages`
--

DROP TABLE IF EXISTS `j3_messages`;
CREATE TABLE IF NOT EXISTS `j3_messages` (
...
--
-- Структура таблицы `j3_messages_cfg`
--

DROP TABLE IF EXISTS `j3_messages_cfg`;
CREATE TABLE IF NOT EXISTS `j3_messages_cfg` (
...
--
-- Структура таблицы `j3_modules`
--

DROP TABLE IF EXISTS `j3_modules`;
CREATE TABLE IF NOT EXISTS `j3_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
INSERT INTO `j3_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Главное меню', '', '', 1, 'mx_menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
(88, 57, 'Модуль формы Fabrik', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_fabrik_form', 1, 1, '', 0, '*'),
(89, 66, 'Модуль списка Fabrik', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_fabrik_list', 1, 1, '', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_modules_menu`
--

DROP TABLE IF EXISTS `j3_modules_menu`;
CREATE TABLE IF NOT EXISTS `j3_modules_menu` (
...
--
-- Дамп данных таблицы `j3_modules_menu`
--

INSERT INTO `j3_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `j3_newsfeeds`
--

DROP TABLE IF EXISTS `j3_newsfeeds`;
CREATE TABLE IF NOT EXISTS `j3_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_overrider`
--

DROP TABLE IF EXISTS `j3_overrider`;
CREATE TABLE IF NOT EXISTS `j3_overrider` (
...
--
-- Структура таблицы `j3_postinstall_messages`
--

DROP TABLE IF EXISTS `j3_postinstall_messages`;
CREATE TABLE IF NOT EXISTS `j3_postinstall_messages` (
...
--
-- Дамп данных таблицы `j3_postinstall_messages`
--

INSERT INTO `j3_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `j3_redirect_links`
--

DROP TABLE IF EXISTS `j3_redirect_links`;
CREATE TABLE IF NOT EXISTS `j3_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_schemas`
--

DROP TABLE IF EXISTS `j3_schemas`;
CREATE TABLE IF NOT EXISTS `j3_schemas` (
...
--
-- Дамп данных таблицы `j3_schemas`
--

INSERT INTO `j3_schemas` (`extension_id`, `version_id`) VALUES
...
--
-- Структура таблицы `j3_session`
--

DROP TABLE IF EXISTS `j3_session`;
CREATE TABLE IF NOT EXISTS `j3_session` (
...
--
-- Дамп данных таблицы `j3_session`
--

INSERT INTO `j3_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('chmd9k76ltci6udo092h45f731', 1, 1, '1472041836', 'joomla|s:1724:"";', 0, ''),
('eroij9dgrgobchornhp6ap53t3', 0, 1, '1472040549', 'joomla|s:576:"";', 0, '');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_tags`
--
...
--
-- Структура таблицы `j3_template_styles`
--

DROP TABLE IF EXISTS `j3_template_styles`;
CREATE TABLE IF NOT EXISTS `j3_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `j3_template_styles`
--

INSERT INTO `j3_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'mxsimple', 0, '1', 'MXSimple - По умолчанию', '{}');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_ucm_base`
--

DROP TABLE IF EXISTS `j3_ucm_base`;
CREATE TABLE IF NOT EXISTS `j3_ucm_base` (
...
--
-- Структура таблицы `j3_ucm_content`
--

DROP TABLE IF EXISTS `j3_ucm_content`;
CREATE TABLE IF NOT EXISTS `j3_ucm_content` (
...
--
-- Структура таблицы `j3_ucm_history`
--

DROP TABLE IF EXISTS `j3_ucm_history`;
CREATE TABLE IF NOT EXISTS `j3_ucm_history` (
...
--
-- Дамп данных таблицы `j3_ucm_history`
--

INSERT INTO `j3_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 2, 6, '', '2014-09-10 17:35:05', 148, 636, '70ab5ff41f6211ade24bc6960eb91b699cc0ae1d', '{"id":2,"asset_id":"27","parent_id":"1","lft":"1","rgt":"2","level":"1","path":"uncategorised","extension":"com_content","title":"\\u0411\\u0435\\u0437 \\u043a\\u0430\\u0442\\u0435\\u0433\\u043e\\u0440\\u0438\\u0438","alias":"uncategorised","note":"","description":"","published":"1","checked_out":"148","checked_out_time":"2014-09-10 17:34:42","access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"42","created_time":"2011-01-01 00:00:01","modified_user_id":"148","modified_time":"2014-09-10 17:35:05","hits":"0","language":"*","version":"1"}', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_updates`
--

DROP TABLE IF EXISTS `j3_updates`;
CREATE TABLE IF NOT EXISTS `j3_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Available Updates' AUTO_INCREMENT=67 ;

--
-- Дамп данных таблицы `j3_updates`
--

INSERT INTO `j3_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(36, 3, 10002, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
...
(63, 8, 10030, 'JCE Editor', '', 'com_jce', 'component', '', 1, '2.5.11', '', 'https://www.joomlacontenteditor.net/index.php?option=com_updates&view=update&format=xml&id=1&file=extension.xml', 'http://www.joomlacontenteditor.net/news/item/jce-2510-released', ''),
(64, 9, 801, 'Weblinks Extension Package', 'Joomla! CMS Weblinks Package', 'pkg_weblinks', 'package', '', 0, '3.4.1', '', 'https://raw.githubusercontent.com/joomla-extensions/weblinks/master/manifest.xml', 'https://github.com/joomla-extensions/weblinks/releases/tag/3.4.1', ''),
(66, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.6.2', '', 'https://update.joomla.org/core/sts/extension_sts.xml', '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_update_sites`
--

DROP TABLE IF EXISTS `j3_update_sites`;
CREATE TABLE IF NOT EXISTS `j3_update_sites` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Update Sites' AUTO_INCREMENT=14 ;

--
-- Дамп данных таблицы `j3_update_sites`
--

INSERT INTO `j3_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1472040494, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1472040220, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1449486451, ''),
(5, 'WebInstaller Update Site', 'extension', 'http://appscdn.joomla.org/webapps/jedapps/webinstaller.xml', 1, 1449486451, ''),
(6, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1449486451, ''),
...
(13, 'Fabrik31', 'collection', 'http://fabrikar.com/update/fabrik31/package_list.xml', 1, 0, '');

-- --------------------------------------------------------

--
-- Структура таблицы `j3_update_sites_extensions`
--

DROP TABLE IF EXISTS `j3_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `j3_update_sites_extensions` (
...
--
-- Дамп данных таблицы `j3_update_sites_extensions`
--

INSERT INTO `j3_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(3, 10002),
...
--
-- Структура таблицы `j3_usergroups`
--

DROP TABLE IF EXISTS `j3_usergroups`;
CREATE TABLE IF NOT EXISTS `j3_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `j3_usergroups`
--

INSERT INTO `j3_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `j3_users`
--

DROP TABLE IF EXISTS `j3_users`;
CREATE TABLE IF NOT EXISTS `j3_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(148, 'Super User', 'admin', 'regger@mxsite.ru', '$2y$10$GzTxoeslTHEgzg4yZjqy2OjAP3/RC51FXq9l0NU8vzyvVc3j2YBua', 0, 1, '2014-09-10 17:12:58', '2016-08-24 12:30:35', '0', '{"admin_style":"","admin_language":"ru-RU","language":"ru-RU","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_user_keys`
--

DROP TABLE IF EXISTS `j3_user_keys`;
CREATE TABLE IF NOT EXISTS `j3_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `j3_user_notes`
--

DROP TABLE IF EXISTS `j3_user_notes`;
CREATE TABLE IF NOT EXISTS `j3_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `j3_user_profiles`
--

DROP TABLE IF EXISTS `j3_user_profiles`;
CREATE TABLE IF NOT EXISTS `j3_user_profiles` (
...
--
-- Структура таблицы `j3_user_usergroup_map`
--

DROP TABLE IF EXISTS `j3_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `j3_user_usergroup_map` (
...
--
-- Дамп данных таблицы `j3_user_usergroup_map`
--

INSERT INTO `j3_user_usergroup_map` (`user_id`, `group_id`) VALUES
(148, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_utf8_conversion`
--

DROP TABLE IF EXISTS `j3_utf8_conversion`;
CREATE TABLE IF NOT EXISTS `j3_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Дамп данных таблицы `j3_utf8_conversion`
--

INSERT INTO `j3_utf8_conversion` (`converted`) VALUES
(1);

-- --------------------------------------------------------

--
-- Структура таблицы `j3_viewlevels`
--

DROP TABLE IF EXISTS `j3_viewlevels`;
CREATE TABLE IF NOT EXISTS `j3_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `j3_viewlevels`
--

INSERT INTO `j3_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Структура таблицы `j3_weblinks`
--

DROP TABLE IF EXISTS `j3_weblinks`;
CREATE TABLE IF NOT EXISTS `j3_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `j3_wf_profiles`
--

DROP TABLE IF EXISTS `j3_wf_profiles`;
CREATE TABLE IF NOT EXISTS `j3_wf_profiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `j3_wf_profiles`
--

INSERT INTO `j3_wf_profiles` (`id`, `name`, `description`, `users`, `types`, `components`, `area`, `device`, `rows`, `plugins`, `published`, `ordering`, `checked_out`, `checked_out_time`, `params`) VALUES
(1, 'Default', 'Default Profile for all users', '', '6,7,3,4,5,8', '', 0, 'desktop,tablet,phone', 'help,newdocument,undo,redo,spacer,bold,italic,underline,strikethrough,justifyfull,justifycenter,justifyleft,justifyright,spacer,blockquote,formatselect,styleselect,removeformat,cleanup;fontselect,fontsizeselect,forecolor,backcolor,spacer,clipboard,indent,outdent,lists,sub,sup,textcase,charmap,hr;directionality,fullscreen,preview,source,print,searchreplace,spacer,table;visualaid,visualchars,visualblocks,nonbreaking,style,xhtmlxtras,anchor,unlink,link,imgmanager,spellchecker,article,mediamanager,imgmanager_ext,templatemanager', 'charmap,contextmenu,browser,inlinepopups,media,help,clipboard,searchreplace,directionality,fullscreen,preview,source,table,textcase,print,style,nonbreaking,visualchars,visualblocks,xhtmlxtras,imgmanager,anchor,link,spellchecker,article,lists,formatselect,styleselect,fontselect,fontsizeselect,fontcolor,mediamanager,imgmanager_ext,templatemanager', 1, 1, 0, '0000-00-00 00:00:00', '{"editor":{"toggle_label":"\\u041e\\u0442\\u043a\\u043b\\u044e\\u0447\\u0438\\u0442\\u044c\\/\\u0432\\u043a\\u043b\\u044e\\u0447\\u0438\\u0442\\u044c \\u0432\\u0438\\u0437\\u0443\\u0430\\u043b\\u044c\\u043d\\u044b\\u0439 \\u0440\\u0435\\u0434\\u0430\\u043a\\u0442\\u043e\\u0440","extended_elements":"iframe","allow_javascript":"1","allow_css":"1","allow_php":"1"}}'),
